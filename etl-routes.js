  ...
  var routes = [
    ...
    },
    {
      ...
      config: {
        ...
        description: 'Endpoint that receives feedback from a private channel',
        notes:
          'Specify the private channel name,message  count and oldest timestamp in the url parameters',
        tags: ['api', 'feedback'],
      },
    },
    {
      ...
      config: {
          ...
          if (request.query.locationUuids) {
            preRequest.resolveLocationIdsToLocationUuids(request, function () {
              ...
              let reportParams = etlHelpers.getReportParams(
                ...
                ['startDate', 'endDate', 'locations', 'groupBy'],
              ...
              dao
                ...
                .then((result) => {
                  _.each(result.result, (row) => {
                    row.order_type = etlHelpers.getTestsOrderedNames(
                      row.order_type
                    );
                    row.cur_meds = etlHelpers.getARVNames(row.cur_meds);
                  });
        ...
        description:
          'Get a list of patients who made lab orders on a selected date',
        notes:
          'Returns a list of patients patients who made lab orders through selected clinics on a selected date',
        tags: ['api'],
      },
    },
    {
      ...
      config: {
        ...
        description: 'Endpoint that gets user feedback from poc',
        notes:
          'Specify message count and oldest timestamp in the url parameters',
        tags: ['api', 'feedback'],
      },
    },
    {
      ...
      config: {
        ...
        description:
          'Endpoint that post user feedback from client to  a public slack channel',
        notes: 'Specify the public channel name in the payload',
        tags: ['api', 'feedback'],
      },
    },
    {
      ...
      config: {
        ...
        description:
          'Endpoint that post user feedback from client to  a private slack channel',
        notes: 'Specify the private channel name in the payload',
        tags: ['api', 'feedback'],
      },
    },
    ...
    },
    {
      ...
      config: {
        ...
        description: 'Endpoint that receives feedback from a public channel',
        notes:
          'Specify the public channel name,message  count and oldest timestamp in the url parameters',
        tags: ['api', 'feedback'],
      },
    },
    {
    ...
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          if (request.query.locationUuids) {
            programVisitEncounterResolver
              .resolveProgramVisitTypeEncounterUuidsParamsToIds(request.query)
              .then((resolve) => {
                let encounterIds = resolve.encounterTypeIds;
                let visitTypeIds = resolve.visitTypesIds;
                let programTypeIds = resolve.programTypeIds;
                ...
                return resolveLocationUuidToId.resolveLocationUuidsParamsToIds(
                  request.query
                );
              })
              .then((result) => {
                ...
                let service = new MonthlyScheduleService();
                service
                  .getMonthlyScheduled(combineRequestParams)
                  .then((result) => {
                    reply(result);
                  })
                  .catch((error) => {
            ...
            preRequest.resolveLocationIdsToLocationUuids(request, function () {
              ...
              programVisitEncounterResolver
                ...
                .then((resolve) => {
                  ...
                  // let reportParams = etlHelpers.getReportParams('daily-appointments', ['startDate', 'locations', 'encounterIds', 'visitTypeIds', 'programTypeIds', 'groupBy'], compineRequestParams);
                  combineRequestParams.limitParam = combineRequestParams.limit;
                  combineRequestParams.offSetParam =
                    combineRequestParams.startIndex;
                  combineRequestParams.endDate = combineRequestParams.startDate;
                  let service = new PatientlistMysqlReport(
                    'dailyAppointmentsAggregate',
                    combineRequestParams
                  );
                  service
                    .generatePatientListReport(['patients'])
                    .then((result) => {
                      let returnedResult = {};
                      returnedResult.schemas = result.schemas;
                      returnedResult.sqlQuery = result.sqlQuery;
            ...
            preRequest.resolveLocationIdsToLocationUuids(request, function () {
              ...
              programVisitEncounterResolver
                ...
                .then((resolve) => {
                  ...
                  compineRequestParams.limitParam = compineRequestParams.limit;
                  compineRequestParams.offSetParam =
                    compineRequestParams.startIndex;
                  let service = new PatientlistMysqlReport(
    ...
    },
    {
      ...
      config: {
        ...
        description:
          'Get a list of patients who did not attend a scheduled visit',
        notes:
          'Returns a list of patients who did not attend their scheduled visits on the selected date',
        tags: ['api'],
      },
    },
    {
        ...
        handler: function (request, reply) {
          if (request.query.locationUuids) {
            preRequest.resolveLocationIdsToLocationUuids(request, function () {
              ...
              let reportParams = etlHelpers.getReportParams(
                'clinic-lab-orders-report',
                ['dateActivated', 'locations', 'groupBy'],
                compineRequestParams
              );
              let report = new BaseMysqlReport(
                'clinicLabOrdersReport',
    ...
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          ...
          let service = new CDMReportingService();
          service
            .getPatientSummaryReport(requestParams)
            .then((result) => {
              reply(result);
            })
            .catch((error) => {
        ...
        description: 'Get patient CDM summary',
        notes:
          "Returns a list of historical patient's HIV summary with the given patient uuid. " +
          "A patient's CDM summary includes details such as last visit date, " +
          "current medication regimen etc. as at that encounter's date. ",
        tags: ['api'],
        validate: {
          ...
          params: {
            patientUuids: Joi.string()
              .required()
              .description(
                "The patient's uuid(universally unique identifier)."
              ),
          },
        },
      },
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          ...
          let service = new CDMReportingService();
          service
            .getPatientMedicationHistoryReport(requestParams)
            .then((result) => {
              reply(result);
            })
            .catch((error) => {
...
>>>>>>> Stashed changes
        ...
        validate: {
          ...
          params: {
            ...
            enrollmentUuid: Joi.string()
              .required()
              .description(
                'program enrollment Uuid (universally unique identifier).'
              ),
          },
        },
      },
    },
    {
      ...
      config: {
        ...
        notes:
          'Returns a list of notes constructed from several ' +
    ...
    },
    {
      ...
      config: {
        ...
        notes:
          "Returns a list of historical patient's vitals with the given patient uuid.",
        tags: ['api'],
        validate: {
          options: {
            allowUnknown: true,
    ...
    },
    {
      ...
      config: {
        ...
        notes:
          'Returns a list of historical lab tests data of a patient with the given patient uuid.',
        tags: ['api'],
        validate: {
          options: {
            allowUnknown: true,
...
=======
    ...
    },
    {
      ...
      config: {
        ...
        description: 'Get patient Oncology summary',
        notes:
          "Returns a list of patient's Oncology summary with the given patient uuid. " +
          "A patient's Oncology summary includes details such as last appointment date, " +
          "most recent diagnosis etc. as at that encounter's date. ",
        tags: ['api'],
        validate: {
    ...
    },
    {
      ...
      config: {
        ...
        description: "Get a location's monthly appointment visits",
        notes:
          "Returns a location's monthly appointment visits with the given location uuid.",
        tags: ['api'],
        validate: {
          options: {
            allowUnknown: true,
          ...
          params: {
            uuid: Joi.string()
              .required()
              .description(
                "The location's uuid(universally unique identifier)."
              ),
          },
        },
      },
      ...
      config: {
        ...
        handler: function (request, reply) {
          ...
          preRequest.resolveLocationIdsToLocationUuids(request, function () {
            ...
            let reportParams = etlHelpers.getReportParams(
              'clinical-hiv-comparative-overview-report',
              [
                'startDate',
                'endDate',
                'indicator',
            ...
            let service = new hivComparativeOverviewService();
            service
              .getAggregateReport(compineRequestParams)
              .then((result) => {
                reply(result);
              })
              .catch((error) => {
        ...
        description: 'Get the clinical hiv comparative overview summary',
        notes:
          'Returns a comparative summary of various indicator eg enrollement, on_art,and vl suppression',
        tags: ['api'],
        validate: {},
      },
    },
    {
      ...
      config: {
        ...
        description: 'Get the clinical hiv comparative overview patient',
        notes:
          'Returns the patient list for various indicators in the clinical hiv comparative summary',
        tags: ['api'],
        validate: {
          query: {
            indicator: Joi.string()
      ...
      config: {
        ...
        plugins: {
          openmrsLocationAuthorizer: {
            ...
            aggregateReport: [
              //set this if you want to  validation checks for certain aggregate reports
              {
                type: 'query', //can be in either query or params so you have to specify
                name: 'reportName', //name of the parameter
                value: 'patient-referral-report', //parameter value
        ...
        handler: function (request, reply) {
          ...
          preRequest.resolveLocationIdsToLocationUuids(request, function () {
            ...
            delete requestParams['gender'];
            service
              .getAggregateReport(requestParams)
              .then((result) => {
                reply(result);
              })
              .catch((error) => {
        ...
        description: 'Get patient referral for selected clinic',
        notes:
          'Returns a list of patient referral for the selected clinic(s),start date, end date',
        tags: ['api'],
        validate: {
          query: {
            locationUuids: Joi.string()
    ...
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          ...
          service
            .getPatientListReport2(requestParams)
            .then((result) => {
              reply(result);
            })
            .catch((error) => {
        ...
        description: 'Get patient referral for selected clinic',
        notes:
          'Returns patient referral for the selected clinic(s),start date, end date',
        tags: ['api'],
        validate: {
          query: {
            locationUuids: Joi.string()
    ...
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          patientReferralDao
            .getPatientReferralByEnrollmentUuid(
              request.params['locationUuid'],
              request.params['enrollmentUuid']
            )
            .then(function (referralLocation) {
              reply(referralLocation);
            })
        ...
        description: 'Get patient referral details by program enrollment uuid',
        notes:
          'Api endpoint that returns additional patient referral details by program enrollement uuid',
        tags: ['api'],
      },
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          patientReferralDao
            .createPatientReferral(request.payload)
            .then(function (newCohortReferral) {
              reply(newCohortReferral);
            })
            .catch(function (error) {
    ...
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          // console.log('xxxxxxxxxxxx', request)
          patientReferralDao
            .updatePatientReferralNotification(
              request.params['patientReferralId'],
              request.payload
            )
            .then(function (updatedPatientReferral) {
              reply(updatedPatientReferral);
        ...
        description: 'Update patient referral notification status',
        notes:
          'Api endpoint that updates patient referral of by the provided id',
        tags: ['api'],
      },
    },
    {
      ...
      config: {
        ...
        description: 'Get the clinical patint care status patient list',
        notes:
          'Returns a comparative summary of all patient status indicators eg on_art,out_of_care,in_care,transferred_out.....',
        tags: ['api'],
        validate: {},
      },
    },
    {
      ...
      config: {
        ...
        description:
          'Get the clinical-patient-care-status-overview patient list',
        notes:
          'Returns the patient list for various indicators in the clinical-patient-care-status-overview',
        tags: ['api'],
        validate: {
          query: {
            indicator: Joi.string()
            ...
            limit: Joi.number()
              .required()
              .description('The offset to control pagination'),
            analysis: Joi.string().optional().description('analysis type'),
          },
        },
      },
    },
    {
      ...
      config: {
        ...
        description: 'Get the clinical art  overview summary',
        notes:
          'Returns the a comparative summary of art drugs used by patients',
        tags: ['api'],
        validate: {},
      },
    },
    ...
    },
    {
      ...
      config: {
        ...
        description: "Get a location's appointment schedule",
        notes:
          "Returns a location's appointment-schedule with the given location uuid.",
        tags: ['api'],
        validate: {
          options: {
            allowUnknown: true,
    ...
    },
    {
      ...
      config: {
        ...
        description: "Get a location's lab orders data",
        notes:
          "Returns a location's lab orders data with the given location uuid.",
        tags: ['api'],
        validate: {
          options: {
            allowUnknown: true,
    ...
    },
    {
      ...
      config: {
        ...
        description: 'Get the the care status of patient on a monthly basis',
        notes:
          'Returns a list showing care status of a patient at the end of every month in a given period',
        tags: ['api'],
        validate: {
          options: {
            allowUnknown: true,
    ...
    },
    {
      ...
      config: {
        ...
        description: "Get a location's daily visits",
        notes:
          "Returns a location's daily visits with the given parameter uuid.",
        tags: ['api'],
        validate: {
          options: {
            allowUnknown: true,
    ...
    },
    {
      ...
      config: {
        ...
        description: "Get a location's not returned visits",
        notes:
          "Returns a location's not returned visits with the given parameter uuid.",
        tags: ['api'],
        validate: {
          options: {
            allowUnknown: true,
    ...
    },
    {
      ...
      config: {
        ...
        description: "Get a location's monthly visits",
        notes:
          'Returns the actual number of patient visits for each day in a given month and location.',
        tags: ['api'],
        validate: {
          options: {
            allowUnknown: true,
    ...
    },
    {
      ...
      handler: function (request, reply) {
        ...
        var headers = _.union(
          'Authorization, Content-Type, If-None-Match'.split(', '),
          additionalHeaders
        );
    ...
    },
    {
      ...
      config: {
        ...
        plugins: {
          hapiAuthorization: {
            roles: [
              privileges.canViewDataEntryStats,
        ...
        notes:
          'Returns a list of patients created within a specified time period in all locations.',
        tags: ['api'],
        validate: {
          options: {
            allowUnknown: true,
...
=======
      ...
      config: {
        ...
        plugins: {
          openmrsLocationAuthorizer: {
            ...
            exemptedParameter: [
              //set this if you want to prevent validation checks for certain reports
              {
                type: 'query', //can be in either query or params so you have to specify
                name: 'report', //name of the parameter
                value: 'clinical-reminder-report', //parameter value
        ...
        description: 'Get report ',
        notes:
          'General api endpoint that returns a report by passing ' +
          'the report name parameter and a list of custom parameters ' +
          'depending on the report e.g start date, end date for MOH-731 report.',
        tags: ['api'],
        validate: {
    ...
    },
    {
      ...
      config: {
        ...
        description: 'Get the MOH 731 report',
        notes:
          'Api endpoint that returns MOH 731 report. It includes both MOH versions (legacy and 2017).',
        tags: ['api'],
        validate: {
          query: {
            locationUuids: Joi.string()
    ...
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          patientList
            .getCohortUser(request.params['cohortUserId'])
            .then(function (cohortUser) {
              if (cohortUser === null) {
                reply(Boom.notFound('Resource does not exist'));
              } else {
    ...
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          patientList
            .voidCohortUser(request.params['cohortUserId'])
            .then(function (message) {
              reply(message);
            })
            .catch(function (error) {
    ...
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          patientList
            .updateCohortUser(request.params['cohortUserId'], request.payload)
            .then(function (updatedCohortUser) {
              reply(updatedCohortUser);
            })
            .catch(function (error) {
    ...
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          patientList
            .createCohortUser(request.payload)
            .then(function (newCohortUser) {
              reply(newCohortUser);
            })
            .catch(function (error) {
    ...
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          patientList
            .getCohortUsersByCohortUuid(request.params['cohortUuid'])
            .then(function (cohortUsers) {
              reply(cohortUsers);
            })
            .catch(function (error) {
    ...
    },
    {
      ...
      config: {
        ...
        description: 'Get hiv summary indicators for selected clinic',
        notes:
          'Returns hiv summary indicators for the selected clinic(s),start date, end date',
        tags: ['api'],
        validate: {
          query: {
            indicators: Joi.string()
    ...
    },
    {
      ...
      config: {
        ...
        notes:
          "Returns hiv summary indicator's patient list for the selected clinic,start date, end date",
        tags: ['api'],
        validate: {
          query: {
            indicator: Joi.string()
    ...
    },
    {
      ...
      config: {
        ...
        description: 'Get hiv summary monthly indicators for  selected clinic',
        notes:
          'Returns hiv summary monthly indicators for the selected clinic(s),start date, end date',
        tags: ['api'],
        validate: {
          query: {
            indicators: Joi.string()
    ...
    },
    {
      ...
      config: {
        ...
        description:
          "Get hiv summary monthly indicator's patient list for selected clinic",
        notes:
          "Returns hiv summary monthly indicator's patient list for the selected clinic,start date, end date",
        tags: ['api'],
        validate: {
          query: {
            indicator: Joi.string()
    ...
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          if (
            request.params.sub === 'patientList' &&
            !authorizer.hasPrivilege(privileges.canViewPatient)
          ) {
            return reply(Boom.forbidden('Unauthorized'));
          }
...
=======
      ...
      config: {
        ...
        handler: function (request, reply) {
          ...
          if (handler) {
            patientListCompare
              .fetchAndCompareList(
                request.payload.patientList,
                requestObject,
                handler
              )
              .then(function (comparison) {
                if (
                  request.query.includeBoth === true ||
                  request.query.includeBoth === 'true'
                ) {
                  reply(comparison);
                } else {
    ...
    },
    {
      ...
      config: {
        ...
        description: 'Get patient list',
        notes:
          'Returns a patient by passing a given indicator, report and location.',
        tags: ['api'],
        validate: {
          options: {
            allowUnknown: true,
    ...
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          if (request.query.startDate && request.query.endDate) {
            eidService
              .getPatientIdentifiersFromEIDResults(
                request.query.startDate,
                request.query.endDate
              )
              .then(function (response) {
      ...
      config: {
        ...
        handler: function (request, reply) {
          motd
            ...
            .then(function (motdNotifications) {
              if (motdNotifications === null) {
                reply(Boom.notFound('Resource does not exist'));
              } else {
                reply(motdNotifications);
    ...
    },
    {
      ...
      config: {
        ...
        description: 'Gets patients Requiring VL list', //patientsRequiringVLService
        notes:
          'Returns the patient list for various indicators in the labs report',
        tags: ['api'],
        validate: {
          query: {
            locationUuids: Joi.string()
    ...
    },
    {
      ...
      config: {
        ...
        description: 'Gets patient-care-cascade-report',
        notes:
          'Returns a comparative summary of various indicator eg ltfu, on_art,and vl suppression',
        tags: ['api'],
        validate: {},
      },
    },
      ...
      config: {
        ...
        handler: function (request, reply) {
          ...
          report
            ...
            .then((result) => {
              let medicalHist = new patientMedicationHistService();
              let processedResults = medicalHist.processMedicationHistory(
                result
              );
              reply(processedResults);
            })
    ...
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          let department = request.query.department;
          let departmentPrograms = departmentProgramsService
    ...
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          resolveLocationUuidToId
            ...
            .then((result) => {
              ...
              resolveProgramEnrollmentFilterParams
                .resolveProgramVisitTypeEncounterUuidsParamsToIds(request.query)
                .then((resolve) => {
                  let programTypeIds = resolve.programTypeIds;
                  request.query.programTypeIds = programTypeIds;
                  enrollmentService
                    .getActiveProgramEnrollmentSummary(request.query)
                    .then((result) => {
                      reply(result);
                    })
                    .catch((error) => {
        ...
        description:
          'Get enrollment summary details based on location and time filters',
        notes: 'Returns a list of active patients enrolled',
        tags: ['api'],
      },
    },
    {
      ...
      config: {
        ...
        description: 'Get lab orders based on patient uuid',
        notes:
          'Api endpoint that returns lab order(s) based on the patient uuid',
        tags: ['api'],
        validate: {
          options: {
            allowUnknown: true,
    ...
    },
    {
      ...
      config: {
            ...
            .then((result) => {
              ...
              resolveProgramEnrollmentFilterParams
                ...
                .then((resolve) => {
                  ...
                  request.query.programTypeIds = programTypeIds;
                  enrollmentService
                    .getActiveProgramEnrollmentsPatientList(request.query)
                    .then((result) => {
                      _.each(result.result, (item) => {
                        item.cur_meds = etlHelpers.getARVNames(item.cur_meds);
                      });
        ...
        description:
          'Get a list of patients enrolled in a program in a location in a certain period',
        notes: 'Returns a list of active patients enrolled',
        tags: ['api'],
      },
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          ...
          console.log('requestParams', requestParams);
          imagingService
            .getImagingResultsByPatientIdentifier(requestParams)
            .then(function (results) {
              if (results === null) {
                reply(Boom.notFound('Resource does not exist'));
              } else {
        ...
        description: 'Get particular patient imaging report',
        notes:
          'Api endpoint that returns patient imaging report based on the patient identifier',
        tags: ['api'],
      },
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          ...
          //  console.log('requestParams=====>>>',requestParams);
          imagingService
            .getPatientImagesByPatientIdentifier(requestParams)
            .then(function (results) {
              //        console.log('results',results);
              imagingService.constructWadoUrl(results).then(function (res) {
                reply(res);
              });
            })
            .catch(function (error) {
        ...
        description: 'Get particular radiology patient images',
        notes:
          'Api endpoint that returns patient images based on the patient identifier',
        tags: ['api'],
      },
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          var requestParams = request.query;
          imagingService
            .getAllPatientImages(requestParams)
            .then(function (results) {
              reply(results);
            })
            .catch(function (error) {
    ...
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          var payload = request.payload;
          imagingService
            .postRadiologyImagingComments(payload)
            .then(function (results) {
              reply(results);
            })
            .catch(function (error) {
      ...
      config: {
        ...
        handler: function (request, reply) {
          if (request.query.reportUuid) {
            let reportUuid = request.query.reportUuid;
            oncologyReportsService
              .getSpecificOncologyReport(reportUuid)
              .then((result) => {
                reply(result);
              })
              .catch((error) => {
    ...
    },
    {
      ...
      config: {
        ...
        description:
          'Get breast cancer monthly screening summary details based on location and time filters',
        notes: 'Returns aggregates of breast cancer screening',
        tags: ['api'],
      },
    },
    {
      ...
      config: {
        ...
        description:
          'Get breast cancer monthly screening summary patient list based on location and time filters',
        notes:
          'Returns details of patients who underwent breast cancer screenings',
        tags: ['api'],
      },
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          request.query.reportName =
            'combined-breast-cervical-cancer-monthly-screening-summary';
          preRequest.resolveLocationIdsToLocationUuids(request, function () {
            let requestParams = Object.assign(
              {},
              request.query,
        ...
        description:
          'Get combined breast & cervical cancer monthly screening summary details based on location and time filters',
        notes:
          'Returns aggregates of combined breast & cervical cancer screening',
        tags: ['api'],
      },
    },
    {
      ...
      config: {
        ...
        description:
          'Get combined breast & cervical cancer monthly summary patient list based on location and time filters',
        notes:
          'Returns details of patients who underwent both breast & cervical cancer screenings',
        tags: ['api'],
      },
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          request.query.reportName =
            'cervical-cancer-monthly-screening-summary';
          preRequest.resolveLocationIdsToLocationUuids(request, function () {
            let requestParams = Object.assign(
              {},
              request.query,
            ...
            let reportParams = etlHelpers.getReportParams(
              'cervical-cancer-monthly-summary',
              [
                'startDate',
                'endDate',
                'period',
        ...
        description:
          'Get cervical cancer monthly screening summary based on location and time filters',
        notes: 'Returns aggregates of cervical cancer screenings',
        tags: ['api'],
      },
    },
    ...
    },
    {
      ...
      config: {
        ...
        description:
          'Get lung cancer monthly screening summary based on location and time filters',
        notes: 'Returns aggregates of lung cancer screenings',
        tags: ['api'],
      },
    },
    {
      ...
      config: {
        ...
        description:
          'Get lung cancer monthly screening patient list based on location and time filters',
        notes:
          'Returns details of patients who underwent lung cancer screenings',
        tags: ['api'],
      },
    },
    {
      ...
      config: {
        ...
        description:
          'Get lung cancer treatment summary details based on location and time filters',
        notes: 'Returns aggregates of lung cancer treatment',
        tags: ['api'],
      },
    },
    {
      ...
      config: {
        ...
        description:
          'Get Lung cancer treatment monthly patient list based on location and time filters',
        notes:
          'Returns details of patients who underwent lung cancer treatment',
        tags: ['api'],
      },
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          let kibanaDashboard = kibanaService
            .getKibanaDashboards()
            .then((result) => {
              console.log('Kibana Dashboard', result);
              reply(result);
      ...
      config: {
        ...
        handler: function (request, reply) {
          ...
          let report = new PatientlistMysqlReport(
            'differentiatedCareProgramAggregate',
            requestParams
          );
          report
    ...
    },
    {
      ...
      config: {
        ...
        handler: function (request, reply) {
          ...
          service
            .getPatientListReport3(requestParams)
            .then((result) => {
              reply(result);
            })
            .catch((error) => {
        ...
        description: 'Get the patient list for CDM strengths study',
        notes:
          'Returns the normal referral patient list plus some additional columns for front end processing',
        tags: ['api'],
        validate: {
          query: {
            locationUuids: Joi.string()
      ...
      config: {
        ...
        handler: function (request, reply) {
          preRequest.resolveLocationIdsToLocationUuids(request, function () {
            ...
            let surgeService = new SurgeService(
              'surge',
              reportParams.requestParams
            );
            surgeService
        ...
        handler: function (request, reply) {
          if (request.query.locationUuids) {
            preRequest.resolveLocationIdsToLocationUuids(request, function () {
              ...
              let retentionService = new RetentionAppointmentTracingService(
                'retention-report',
                reportParams.requestParams
              );
              retentionService
      ...
      config: {
        ...
        handler: function (request, reply) {
          preRequest.resolveLocationIdsToLocationUuids(request, function () {
            ...
            let heiSummaryService = new HeiSummaryService(
              'MOH-408',
              reportParams.requestParams
            );
            heiSummaryService
